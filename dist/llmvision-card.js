import{O as e,c as t,i as n,l as r,n as i,o as a,t as o,u as s}from"./assets/lit-1FZc1AOd.js";import{LLMVisionPreviewCard as c,a as l,i as u,n as d,r as f,t as p}from"./llmvision-preview-card.js";var m=e((()=>{r(),u(),o(),f(),p();var e=class extends i{static get properties(){return{_config:{type:Object}}}setConfig(e){this._config=e||{}}render(){if(!this._config)return n`<div>Please configure the card.</div>`;let e=this._getSchema(),t=e.slice(0,3),r=e.slice(3,6),i=e.slice(6,8),a=e.slice(8);return n`
            <style>
